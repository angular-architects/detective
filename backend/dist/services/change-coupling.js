    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          modules = displayModules.map(function (m) {
...
function addToMatrix(touchedModules, matrix) {
  ...
  for (
    var _i = 0, touchedArray_1 = touchedArray;
    _i < touchedArray_1.length;
    _i++
  ) {
    var module1 = touchedArray_1[_i];
    for (
      var _a = 0, touchedArray_2 = touchedArray;
      _a < touchedArray_2.length;
      _a++
    ) {
