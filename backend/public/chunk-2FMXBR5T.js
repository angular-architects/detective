...
var H = null,
  Et = !1;
function ks(n) {
  H || ((H = Ds() || {}), (Et = H.style ? 'WebkitAppearance' in H.style : !1));
  let e = !0;
  return (
    H.style &&
      !Cs(n) &&
      ...
      !e &&
        Et &&
        (e = 'Webkit' + n.charAt(0).toUpperCase() + n.slice(1) in H.style)),
    e
  );
}
function Ai(n) {
...
function Ls(n, e, t) {
  ...
  if (typeof n == 'string') {
    let o = n.match(s);
    if (o === null) return e.push(_t(n)), { duration: 0, delay: 0, easing: '' };
...
var At = '',
  $e = class {
    ...
    visitTrigger(e, t) {
      ...
      return (
        ...
        e.definitions.forEach((o) => {
          if ((this._resetContextStyleTimingState(t), o.type == E.State)) {
            let l = o,
              h = l.name;
            h
              .toString()
    ...
    visitGroup(e, t) {
      ...
      return (
        (t.currentTime = i), { type: E.Group, steps: r, options: Y(e.options) }
      );
    }
    visitAnimate(e, t) {
      ...
      if (r.type == E.Keyframes) i = this.visitKeyframes(r, t);
      else {
        let a = e.styles,
          o = !1;
        if (!a) {
      ...
      return (
        ...
        { type: E.Animate, timings: s, style: i, options: null }
      );
    }
    visitStyle(e, t) {
    ...
    _makeStyleAst(e, t) {
      ...
      return (
        s.forEach((o) => {
          if (
            o instanceof Map &&
            (o.has('easing') && ((a = o.get('easing')), o.delete('easing')), !r)
          ) {
            ...
            a.forEach((o, l) => {
              ...
              c &&
                (r != i &&
                  r >= c.startTime &&
                  i <= c.endTime &&
                  (t.errors.push(ns(l, c.startTime, c.endTime, r, i)),
                  (u = !1)),
                (r = c.startTime)),
    ...
    visitKeyframes(e, t) {
      let s = { type: E.Keyframes, styles: [], options: null };
    ...
    visitAnimateChild(e, t) {
      return t.depCount++, { type: E.AnimateChild, options: Y(e.options) };
    }
    visitAnimateRef(e, t) {
      return {
        type: E.AnimateRef,
...
function Y(n) {
  return (
    n ? ((n = he({}, n)), n.params && (n.params = Ws(n.params))) : (n = {}), n
  );
}
function De(n, e, t) {
...
var Ue = class {
    ...
    visitGroup(e, t) {
      ...
      e.steps.forEach((a) => {
        ...
        s.forEach((a) => t.currentTimeline.mergeTimelineCollectedStyles(a)),
      ...
      if (r) {
        ...
        a || (a = this.options.params = {}),
          Object.keys(r).forEach((o) => {
            (!t || !a.hasOwnProperty(o)) && (a[o] = re(r[o], a, this.errors));
          });
      }
    }
    _copyOptions() {
      ...
      for (let [o, l] of a) {
        ...
        this._pendingStyles.set(o, h),
          this._localTimelineStyles.has(o) ||
            this._backFill.set(o, this._globalTimelineStyles.get(o) ?? B),
  ...
  ve = class {
    ...
    build(e, t, s, i, r, a, o, l, h, c) {
      ...
      return (
        ...
        u.length
          ? Nt(t, this._triggerName, s, i, N, d, v, [], [], A, C, k, u)
          : (K.forEach((D) => {
              let j = D.element,
                J = L(A, j, new Set());
              D.preStyleProps.forEach((W) => J.add(W));
              let ct = L(C, j, new Set());
              D.postStyleProps.forEach((W) => ct.add(W)), j !== t && b.add(j);
            }),
            Nt(
              t,
              this._triggerName,
      ...
      this.styles.styles.forEach((r) => {
        typeof r != 'string' &&
          r.forEach((a, o) => {
            ...
            (a = this.normalizer.normalizeStyleValue(o, l, a, t)), s.set(o, a);
          });
      }),
      s
    );
...
var ni = new se(),
      ...
      if (r) {
        ...
        if (
          ...
          return (
            ...
            s && U(o).onDone(() => this._engine.processLeaveNode(e)),
            !0
          );
      }
      return !1;
          ...
          a &&
            a.forEach((o) => {
              if (o.name == s.triggerName) {
                ...
                (l._data = e), tt(s.player, o.phase, l, o.callback);
              }
            }),
            i.markedForDestroy
              ? this._engine.afterFlush(() => {
  ...
  Ze = class {
    ...
    markElementAsDisabled(e, t) {
      t
        ? this.disabledNodes.has(e) || (this.disabledNodes.add(e), I(e, Oe))
    ...
    _flushAnimations(e, t) {
      ...
      for (let f = this._namespaceList.length - 1; f >= 0; f--)
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
          ...
          a.push(Gt),
            w.queriedElements.forEach((M) => L(o, M, []).push(T)),
            ...
            w.postStyleProps.forEach((M, G) => {
              let F = h.get(G);
              F || h.set(G, (F = new Set())), M.forEach((le, Ne) => F.add(Ne));
            });
        });
      if (K.length) {
        let f = [];
      ...
      a.forEach((f) => {
        ...
        s.has(m) &&
          (D.set(m, m),
          this._beforeAnimationBuild(f.player.namespaceId, f.instruction, k));
      }),
        i.forEach((f) => {
          let m = f.element;
    ...
    _getPreviousPlayers(e, t, s, i, r) {
      ...
      return (
        (s || i) &&
          (a = a.filter(
            (o) => !((s && s != o.namespaceId) || (i && i != o.triggerName))
          )),
        a
      );
    }
    ...
    _buildAnimation(e, t, s, i, r, a) {
      let o = t.triggerName,
        ...
        _ = t.timelines.map((d) => {
          ...
          c.add(g);
          let v = g[z];
          if (v && v.removedBeforeQueried) return new x(d.duration, d.delay);
          let b = g !== l,
            A = pi((s.get(g) || hi).map((k) => k.getRealPlayer())).filter(
              (k) => {
                let D = k;
      ...
      h.forEach((d) => {
        L(this.playersByQueriedElement, d.element, []).push(d),
          d.onDone(() => ci(this.playersByQueriedElement, d.element, d));
      }),
        c.forEach((d) => I(d, vt));
      let y = U(_);
      return (
...
function Rt(n, e) {
  ...
  function a(o) {
    ...
    if (l) return l;
    let h = o.parentNode;
    return t.has(h) ? (l = h) : i.has(h) ? (l = s) : (l = a(h)), r.set(o, l), l;
  }
  return (
    e.forEach((o) => {
      let l = a(o);
...
var we = class {
  constructor(e, t, s) {
    (this._driver = t),
      ...
      (this._triggerCache = {}),
      (this.onRemovalComplete = (i, r) => {}),
      (this._transitionEngine = new Ze(e.body, t, s)),
    ...
    beforeDestroy() {
      ...
      this.hasStarted() &&
        this._finalKeyframe.forEach((s, i) => {
          i !== 'offset' && e.set(i, this._finished ? s : at(this.element, i));
        }),
...
function Ni(n, e) {
  return n === 'noop'
    ? new we(e, new qt(), new ze())
    : new we(e, new xe(), new Qe());
}
var Lt = class {
    constructor(e, t) {
      this._driver = e;
    ...
    buildTimelines(e, t, s, i, r) {
      let a = Array.isArray(t) ? wt(t) : t,
        ...
        l = [];
      r = r || new se();
      let h = ht(this._driver, e, this._animationAst, nt, ge, a, o, i, r, l);
