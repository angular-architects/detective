...
export interface DependencyMetricResult {
  count: number;
  types: Set<string>;
}
...
export class DependencyMetric extends BaseMetric<DependencyMetricResult> {
  analyze(context: AnalyzerContext): DependencyMetricResult {
    const classNode =
